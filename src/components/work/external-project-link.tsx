...
export function ExternalProjectLink({ href, label, className }: ExternalProjectLinkProps) {
  ...
  return (
    <Link
      ...
      rel="noopener noreferrer"
      className={cn(
        "font-mono inline-flex min-h-10 items-center justify-center gap-1.5 rounded-full border px-3.5 py-2.5 text-[11px] font-semibold uppercase tracking-[0.1em] transition-colors sm:text-xs",
